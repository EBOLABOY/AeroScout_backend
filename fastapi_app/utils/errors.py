...
class UserLevelError:
    ...
    @staticmethod
    def insufficient_level(
        current_level: str,
        required_level: str,
        feature_name: str = "此功能"
    ) -> HTTPException:
        """用户等级不足错误"""
    ...
    def quota_limit_reached(
        ...
        return HTTPException(
            ...
            detail=StandardErrorResponse(
                ...
                suggested_actions=[
                    f"升级到 {next_level} 等级获得更多配额",
                    "等待配额重置",
                    "查看详细使用统计"
                ],
                support_info={
                    "pricing_url": "/pricing",
                    "stats_url": "/auth/stats/daily"
                }
            ).model_dump()
        )
    ...
    def ai_service_unavailable() -> HTTPException:
        ...
        return HTTPException(
            ...
            detail=StandardErrorResponse(
                ...
                support_info={
                    "fallback_url": "/api/flights/search",
                    "status_url": "/status"
                }
            ).model_dump()
        )
...
class SystemError:
    ...
    @staticmethod
    def internal_error(error_id: Optional[str] = None) -> HTTPException:
        """内部系统错误"""
        return HTTPException(
