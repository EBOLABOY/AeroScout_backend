...
class SupabaseService:
    ...
    async def sync_user_from_supabase_auth(self, supabase_user) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if hasattr(supabase_user, 'last_sign_in_at') and supabase_user.last_sign_in_at:
                ...
                if isinstance(supabase_user.last_sign_in_at, str):
                    ...
                    sync_data["last_login"] = supabase_user.last_sign_in_at.isoformat() if hasattr(supabase_user.last_sign_in_at, 'isoformat') else str(supabase_user.last_sign_in_at)
            else:
                # 如果没有登录时间，使用当前时间
